...
public class UserInterface {
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Player 1 places X and player 2 places O. Each player places two pieces per turn. The player with the most four-in-a-rows at the end wins.");
